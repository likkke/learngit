...
class Journal_Item(scrapy.Item):
    # 期刊 索引号
    journal_index = Field()
    # 期刊 名称
    journal_name = Field()
    ...
    # 期刊 论文数目
    #journal_number_of_high_quotations = Field()
    # 期刊 论文可能的数目
    #journal_number_of_high_quotations_possible = Field()

class Basic_information_of_the_paper_publication_Item(scrapy.Item):
    #----------------其他辅助信息-------------------开始----------
    # 期刊 索引号
    journal_index = Field()
    # 期刊 名称
...
class Basic_information_of_the_quoted_paper_publication_Item(scrapy.Item):
    #----------------其他辅助信息-------------------开始----------
    # 期刊 索引号 应为被引论文的title
